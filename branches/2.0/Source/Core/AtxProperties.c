...
ATX_DECLARE_GET_INTERFACE_IMPLEMENTATION(Properties)
ATX_DECLARE_GET_INTERFACE_IMPLEMENTATION(PropertiesIterator)
                          ...
                          ATX_Iterator** object)
{
    ...
    *object = (ATX_Iterator*)iterator;
    if (iterator == NULL) return ATX_ERROR_OUT_OF_MEMORY;
...
ATX_Properties_Create(ATX_Properties** object)
{
    ...
    *object = (ATX_Properties*)properties;
    if (properties == NULL) return ATX_ERROR_OUT_OF_MEMORY;
